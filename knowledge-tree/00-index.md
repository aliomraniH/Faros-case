...
Every node validates against `schemas/knowledge-node.schema.json`.
...
| `mapping:maya-govern-velocity` | mapping | approved | inferred | [maya-govern-velocity.md](mapping/maya-govern-velocity.md) |
...
| `mapping:maya-surveillance-govern` | mapping | approved | inferred | [maya-surveillance-to-govern.md](mapping/maya-surveillance-to-govern.md) |
| `mapping:maya-tool-rationalization` | mapping | approved | sourced | [maya-tool-rationalization.md](mapping/maya-tool-rationalization.md) |
...
- `organization:root` → `mapping:maya-govern-velocity`
...
- `organization:root` → `mapping:maya-surveillance-govern`
- `organization:root` → `mapping:maya-tool-rationalization`
